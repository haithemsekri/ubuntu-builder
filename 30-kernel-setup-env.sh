...
[ -z $KERNEL_DOM0_BIN_NAME ] && KERNEL_DOM0_BIN_NAME="linux-4.19.75-dom0-aarch64-opipc2"
...
[ -z $KERNEL_DOM0_DTB_NAME ] && KERNEL_DOM0_DTB_NAME="linux-4.19.75-dtb-aarch64-opipc2"
...
[ -z $KERNEL_DOMU_BIN_NAME ] && KERNEL_DOMU_BIN_NAME="linux-4.19.75-domu-aarch64-opipc2"
