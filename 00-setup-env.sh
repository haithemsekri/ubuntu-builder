...
[ -z $TARGET_DISK_FILE ] && TARGET_DISK_FILE="$(pwd)/build/ubuntu-18.04-target-arm64.$EXT_FS_TYPE"
[ -z $TARGET_TAR_FILE ]  && TARGET_TAR_FILE="$(pwd)/cache/ubuntu-18.04-target-arm64.tar.gz"
